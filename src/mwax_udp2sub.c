...
#define MAXINSTANCE (3)
    ...
    udp2sub_config_t available_config[MAXINSTANCE] = {
      ...
      ,{ 1,"mwax01",0,8388608,255,255,255,255,"/dev/shm/mwax","/dev/shm/mwax.temp","/mwax_stats","","/vulcan/metafits","192.168.90.201",9,"239.255.90.9",59009}
